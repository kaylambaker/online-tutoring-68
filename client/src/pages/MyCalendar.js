...
const MyCalendar = () => {
  ...
  const createEvent = async () => {
    ...
    if (userRole === 'student') {
      ...
      if (!newEvent.tutorID || !newEvent.appointmentDate || !newEvent.startTime || !newEvent.endTime) {
    ...
    if (userRole === 'tutor') {
      ...
      if (!newEvent.studentID || !newEvent.appointmentDate || !newEvent.startTime || !newEvent.endTime) {
        alert('Please fill in all required fields.');
        return;
      }
    }
      ...
      <div className="modal">
        ...
        <div>
          ...
          <div className="event-form">
            ...
            {userRole === 'student' && (<div className="form-group">
